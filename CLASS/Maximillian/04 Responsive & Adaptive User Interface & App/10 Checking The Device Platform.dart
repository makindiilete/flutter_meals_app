/*
Currently our app looks more of android than ios when we run it on ios... So we need to start working towards an adaptive look and to achieve this, we need to adjust two things : -
1)  Switch : - Our current switch is the default android switch, ios own is a little bit different and we can simply adjust this by calling the 'Switch.adaptive()'... This will automatically adjust the switch to the platform we are currently running on..
2)  FloatingActionButton : - Ds is not an ios thing so on ios we should not show it at all
*/
...
//ds method opens our bottom modal sheet and the modal return our New Transaction form
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      //if we are running on IOS, render nothing, else render the floating action button
