/*
You can assign a dynamic height to your widgets by telling them to take a particular percentage of the entire screen using the code below : -

//Text widget to take 60% of the entire screen height
Container(
      height: MediaQuery.of(context).size.height * 0.6,
      child: Text("Hello")
      );

For our implementation, we want to first deduct the total height taken by the appBar and the phone status bar before we then share the remaining space between our chart and transaction list. So we are going to place our appBar in a variable so we can access its height
*/
