/*
Even though we can lock our app to portrait mode only and that looks like a quick win, it will make sense if we can render alternative content for landscape mode so we have an app that looks good on different device orientation..

A good solution for landscape view is not to render both chart and list at once but to have a switch that we can toggle to render either the chart or transaction list...
*/
...
import '../../../lib/Max/Widget & Styling/models/transaction.dart';
import '../../../lib/Max/Widget & Styling/widgets/transaction_list.dart';
...
//        title: "Weekly Groceries")
  ...
  //ds will control when chart should be visible..
