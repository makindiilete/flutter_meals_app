/*
Now its time to also adjust our transaction form to look more of ios on ios device..We have two things we can change there, our text field and button..
For the textfield, we can change it on ios to : -
CupertinoTextField(
                      controller: _titleController,
                      placeholder: "Title",
                    )
We wont be doing this because the material text field look more elegant
We will simply change our 'Choose Date' button to cupertino
*/
