/*
We are going to see more things we can do with named route : -
1)  We can define our root route which will be our home page
2)  Apps always loads the component dt belong to the homepage when the app is loaded but we can also define our initial route to be different from the root route
3)  Typing out our route name inside main.dart file has a downside because we can have a typo inside the category item and our app will break, so we can avoid ds and use another syntax
*/
...
//      home: CategoriesScreen(),
      //defining our routes
      initialRoute: "/", //ds will b d default route to load when d app starts
      routes: {
