/*
Now we want to finish up our chart bars and adjust a couple of things.
1)  We want to make sure that we shrink a large amount so it wont make our layout distorted.. For this, we can use the 'FittedBox()' widget and pass our spending amount to it
*/
